...
def cmd_prep(args):
    """Run all wiki enrichment (tag-files + extract-glossary + extract-rules)."""
    cmd_tag_files(args)
    print("\n" + "="*60)
...
Examples:
  ...
  python scripts/erc3_prep.py all                   All benchmarks (erc3-dev, erc3-test, erc3)
    ...
    prep_parser = subparsers.add_parser("prep", help="Run all wiki enrichment (tag + glossary + rules)")
